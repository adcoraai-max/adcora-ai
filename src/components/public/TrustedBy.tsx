...
// Technology integration partners list
const techPartners = [
  {
    name: "AWS",
    desc: "Cloud Systems",
  ...
  },
  {
    name: "Sabre",
    desc: "GDS Systems",
    icon: <span className="text-[10px] font-black text-[#E31937] italic font-sans tracking-tight">Sabre</span>,
  },
  {
    name: "Amadeus",
    desc: "Travel API",
    icon: <span className="text-[9px] font-bold text-[#005A9C] font-mono tracking-wider">aMAdEUS</span>,
  },
  {
    name: "OpenAI",
    desc: "Cognitive Models",
    icon: (
      <svg className="h-4.5 w-4.5 fill-emerald-400" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    icon: (
      <svg className="h-4.5 w-4.5 fill-emerald-500" viewBox="0 0 24 24">
  ...
  },
  {
    name: "Travelport",
    desc: "GDS Platform",
    icon: <span className="text-[9px] font-bold text-sky-400 font-sans tracking-wide">Travelport</span>,
  },
  {
    name: "Stripe",
    desc: "Payment Engine",
    icon: <span className="text-[10px] font-black text-[#635bff] font-sans italic tracking-tighter">stripe</span>,
  },
];

// Featured brands and client roster
const clients = [
  {
    name: "Meena Bazar",
    desc: "Fashion Retail",
    icon: <span className="text-[9px] font-extrabold text-[#D4AF37] font-serif tracking-widest uppercase">Meena Bazar</span>,
  },
  {
    name: "Skinovate",
    desc: "Derma Cosmetics",
    icon: <span className="text-[9px] font-black text-rose-400 font-sans tracking-tight uppercase">skinovate</span>,
  },
  {
    name: "Mitchell USA",
    desc: "Skincare TM",
    icon: <span className="text-[8px] font-extrabold text-blue-400 font-mono tracking-tighter uppercase">Mitchell USA</span>,
  },
  {
    name: "Aether CRM",
    desc: "SaaS CRM Systems",
    icon: <span className="text-[9px] font-extrabold text-purple-400 font-sans tracking-tight uppercase">Aether CRM</span>,
  },
  {
    name: "Nova Logistics",
    desc: "Logistics Hub",
    icon: <span className="text-[9px] font-extrabold text-sky-400 font-sans tracking-tight uppercase">Nova Logistics</span>,
  },
  {
    name: "Vertex Design",
    desc: "SaaS Brand Portal",
    icon: <span className="text-[9px] font-extrabold text-emerald-400 font-sans tracking-tight uppercase">Vertex Design</span>,
  },
  {
    name: "Apex Storefront",
    desc: "Headless E-commerce",
    icon: <span className="text-[9px] font-extrabold text-pink-400 font-sans tracking-tight uppercase">Apex Headless</span>,
  },
  {
    name: "Optima Funnels",
    desc: "Conversion Engine",
    icon: <span className="text-[9px] font-extrabold text-indigo-400 font-sans tracking-tight uppercase">Optima Funnels</span>,
  },
];

// Duplicate for seamless loops
const marqueeClients = [...clients, ...clients];
const marqueeTech = [...techPartners, ...techPartners];
      ...
      <div className="page-container space-y-12">
        ...
        >
          ...
          <motion.h3 variants={staggerItem} className="font-display font-black text-xl sm:text-2xl text-white tracking-tight uppercase">
            Trusted By Clients & Tech Partners
          </motion.h3>
          <motion.p variants={staggerItem} className="text-xs sm:text-sm text-muted-foreground max-w-xl mx-auto leading-relaxed">
            We deliver results for fast-growing client brands and integrate our solutions with the world's leading APIs and infrastructure platforms.
          </motion.p>
        </motion.div>

        {/* Double Marquee Tracks */}
        <div className="space-y-8">
          
          {/* Track 1: Client Roster (Scroll Left) */}
          <div className="space-y-3">
            <div className="flex items-center gap-2 px-4 justify-center lg:justify-start">
              <span className="h-1.5 w-1.5 rounded-full bg-secondary animate-pulse" />
              <span className="text-[9px] font-bold text-muted-foreground/80 uppercase tracking-widest">Featured Client Roster</span>
            </div>
          ...
          {/* Track 2: Tech Integrations (Scroll Right - Reverse Marquee) */}
          <div className="space-y-3">
            <div className="flex items-center gap-2 px-4 justify-center lg:justify-start">
              <span className="h-1.5 w-1.5 rounded-full bg-primary animate-pulse" />
              <span className="text-[9px] font-bold text-muted-foreground/80 uppercase tracking-widest">Tech Stack & API Partners</span>
            </div>
